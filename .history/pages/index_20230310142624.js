      ...
      <main className='bg-white px-10'>
       <section className="min-h-screen">
          ...
          <div className='text-center p-9'> 
            <h2 className='text-4xl py-2 text-teal-600 font-medium'>Fateme Soleymanian</h2>
            <h3 className='text-2xl py-2'>Developer</h3>
            <p className='text-md py-5 leading-8 text-gray-800'>Junior developer creating websites and web applications. Join me down below.</p>
          </div>
