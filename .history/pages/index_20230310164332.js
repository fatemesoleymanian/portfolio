...
export default function Home() {
  ...
  return (
    <>
      ...
      <main div className={darkMode ? 'dark' : ''} className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        ...
        <section>
          ...
          <div>
            <div className='md:mx-auto text-center shadow-lg p-10 rounded-xl my-10 md:w-7/12'>
