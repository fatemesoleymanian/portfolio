      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className="min-h-screen">
          ...
          <div className='text-center p-9'>
            ...
            <h3 className='text-2xl md:text-3xl lg:text-4xl py-2'>Full stack Developer</h3>
            <p className='text-md py-5 leading-8 text-gray-700 lg:text-xl
            max-w-xl mx-auto'>
        ...
        <section >
          <div className='mb-0 border-red-600'>
          ...
          <div>
            <div className='md:mx-auto text-center shadow-2xl p-10 rounded-xl my-10 md:w-7/12'>
             ...
             <div className=''>
                ...
                <p className='text-gray-800 py-1'>Java SE</p>
              ...
              <div className=''>
                ...
                <p className='text-gray-800 py-1'>NuxtJs</p>
